...
6. 同一候选池内不能按词库字母顺序固定取第一个词，应按“待学习力”加权随机选择。

“待学习力”是选词权重，不改变 FSRS 复习结果。SQLite 主路径至少应让更早到期、difficulty 更高、stability 更低、lapses/unknown_count 更多、show_count 更少的候选获得更高权重；无学习状态的新词使用基础权重参与随机。
